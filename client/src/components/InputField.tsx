  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        {...props}
        type={type}
        className="w-full py-3 pl-11 pr-11 bg-dark-400 rounded-lg outline-none border border-gray-800 focus:border-logo text-white placeholder:text-sm placeholder-gray-400 placeholder-opacity-50 transition-all duration-300"
      />
    </div>
  );
};
